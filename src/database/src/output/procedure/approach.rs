...
use crate::{enums::ApproachType, output::procedure_leg::ProcedureLeg, sql_structs, v2};
...
pub(crate) fn map_approaches_v2(data: Vec<v2::sql_structs::Procedures>) -> Vec<Approach> {
    let mut missed_started = false;
