...
impl DatabaseTrait for DatabaseV2 {
    ...
    fn get_waypoints(&self, ident: String) -> Result<Vec<Waypoint>, Box<dyn Error>> {
        ...
        let enroute_data =
            util::fetch_rows::<v2::sql_structs::Waypoints>(&mut enroute_stmt, params![ident])?;
        let terminal_data =
            util::fetch_rows::<v2::sql_structs::Waypoints>(&mut terminal_stmt, params![ident])?;
    ...
    fn get_vhf_navaids(&self, ident: String) -> Result<Vec<VhfNavaid>, Box<dyn Error>> {
        ...
        let navaids_data =
            util::fetch_rows::<v2::sql_structs::VhfNavaids>(&mut stmt, params![ident])?;
    ...
    fn get_ndb_navaids(&self, ident: String) -> Result<Vec<NdbNavaid>, Box<dyn Error>> {
        ...
        let enroute_data =
            util::fetch_rows::<v2::sql_structs::NdbNavaids>(&mut enroute_stmt, params![ident])?;
        let terminal_data =
            util::fetch_rows::<v2::sql_structs::NdbNavaids>(&mut terminal_stmt, params![ident])?;
    ...
    fn get_airways(&self, ident: String) -> Result<Vec<Airway>, Box<dyn Error>> {
        ...
        let airways_data =
            util::fetch_rows::<v2::sql_structs::EnrouteAirways>(&mut stmt, params![ident])?;
    ...
    fn get_airways_at_fix(
        ...
        let all_airways = util::fetch_rows::<v2::sql_structs::EnrouteAirways>(
            &mut stmt,
    ...
    fn get_ndb_navaids_in_range(
        ...
        let terminal_data =
            util::fetch_rows::<v2::sql_structs::NdbNavaids>(&mut terminal_stmt, [])?;
    ...
    fn get_communications_in_range(
        ...
        let enroute_data =
            util::fetch_rows::<v2::sql_structs::EnrouteCommunication>(&mut enroute_stmt, [])?;
        let terminal_data =
            util::fetch_rows::<v2::sql_structs::AirportCommunication>(&mut terminal_stmt, [])?;
    ...
    fn get_runways_at_airport(
        ...
        let runways_data =
            util::fetch_rows::<v2::sql_structs::Runways>(&mut stmt, params![airport_ident])?;
    ...
    fn get_departures_at_airport(
        ...
        let departures_data = util::fetch_rows::<v2::sql_structs::Procedures>(
            &mut departures_stmt,
            params![airport_ident],
        )?;
        let runways_data = util::fetch_rows::<v2::sql_structs::Runways>(
            &mut runways_stmt,
            params![airport_ident],
        )?;
    ...
    fn get_arrivals_at_airport(
        ...
        let arrivals_data = util::fetch_rows::<v2::sql_structs::Procedures>(
            &mut arrivals_stmt,
            params![airport_ident],
        )?;
        let runways_data = util::fetch_rows::<v2::sql_structs::Runways>(
    ...
    fn get_approaches_at_airport(
        ...
        let approaches_data = util::fetch_rows::<v2::sql_structs::Procedures>(
            &mut approachs_stmt,
            params![airport_ident],
        )?;
    ...
    fn get_waypoints_at_airport(
        ...
        let waypoints_data =
            util::fetch_rows::<v2::sql_structs::Waypoints>(&mut stmt, params![airport_ident])?;
    ...
    fn get_ndb_navaids_at_airport(
        ...
        let waypoints_data =
            util::fetch_rows::<v2::sql_structs::NdbNavaids>(&mut stmt, params![airport_ident])?;
    ...
    fn get_gates_at_airport(&self, airport_ident: String) -> Result<Vec<Gate>, Box<dyn Error>> {
        ...
        let gates_data =
            util::fetch_rows::<v2::sql_structs::Gate>(&mut stmt, params![airport_ident])?;
    ...
    fn get_communications_at_airport(
        ...
        let gates_data = util::fetch_rows::<v2::sql_structs::AirportCommunication>(
            &mut stmt,
            params![airport_ident],
        )?;
    ...
    fn get_gls_navaids_at_airport(
        ...
        let gates_data =
            util::fetch_rows::<v2::sql_structs::Gls>(&mut stmt, params![airport_ident])?;
    ...
    fn get_path_points_at_airport(
        ...
        let gates_data =
            util::fetch_rows::<v2::sql_structs::Pathpoints>(&mut stmt, params![airport_ident])?;
