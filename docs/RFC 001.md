...
- Values which are not defined should be undefined as opposed to null. This means in the rust implementation, all Option fields should have a skip_serializing attribute
