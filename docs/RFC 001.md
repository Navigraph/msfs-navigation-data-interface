...
get_controlled_airspaces_in_range(center: Coordinates, range: NauticalMiles): Promise<Airway[]>
get_restricted_airspaces_in_range(center: Coordinates, range: NauticalMiles): Promise<Airway[]>
